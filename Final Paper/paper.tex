...
\begin{figure}[!h]
	...
	\caption{A plot of artificially generated data that has then been fit to using the mFourFit equation.}
...
\begin{figure}[!h]
	...
	\caption{Using the first derivative to find peaks.}
...
\begin{figure}[!h]
	...
	\caption{Using the third derivative to find peaks.}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\linewidth]{{"plots/pv_det_final"}.png}
	\caption{Our final peak and valley detection process. This process worked consistently for every dataset that we tried it on.}
